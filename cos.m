...
% Last Modified by GUIDE v2.5 19-Mar-2015 11:52:26
...
% --- Executes on button press in plo.
function plo_Callback(hObject, eventdata, handles)
% hObject    handle from plo (see GCBO)
% eventdata  reserved - from be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
